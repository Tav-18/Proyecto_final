    ...
    if chat_state["step"] == "start":
        ...
        try:
            ...
            if questions.exists():
                ...
                response += "Elige el número de pregunta o escribe '<b>regresar</b>' para volver al menú de categorías:\n"
        ...
        try:
            ...
            if question.categoria == chat_state["selected_category"]:
                response = f"{question.respuestas.first().respuesta_texto}\n\nEscribe '<b>regresar</b>' para volver a las preguntas o '<b>menu</b>' para regresar al menú principal."
        ...
        return JsonResponse({"bot_message": "Escribe '<b>regresar</b>' para volver a las preguntas o '<b>menu</b>' para regresar al menú principal."})
